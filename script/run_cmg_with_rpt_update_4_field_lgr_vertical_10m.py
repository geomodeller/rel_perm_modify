...
refinement (runs/field_porthos_with-update_lgr_vertical_10m).

Same workflow as run_cmg_with_rpt_update_4_field.py, but LGR-aware:

  * The template contains REFINE 20 12 1:43 INTO 10 10 1 (10 m children, vertical well).
  ...
  * rocktype.inc is written as
        ...
        *RTYPE *RG i j k *ALL  (100 child values, one block per refined parent,
...
# GRID CORNER 38 42 43 + REFINE 20 12 1:43 INTO 10 10 1
NX, NY, NZ = 38, 42, 43
...
def main():
    ...
    p.add_argument('--run-dir',  default=os.path.join('runs', 'field_porthos_with-update_lgr_vertical_10m'),
