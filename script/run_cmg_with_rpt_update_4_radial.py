...
# GRID RADIAL 100 36 15 → NX = nr, NY = ntheta, NZ = nz
NX, NY, NZ = 100, 36, 15
N_BLOCKS   = NX * NY * NZ   # 54000
...
def read_last_velocity(sr3_path):
    ...
    vel_last = vx[-1] # No velocity in Y and Z direction
...
def main():
    ...
    p.add_argument('--run-dir',  default=os.path.join('runs', 'radial_homo_with-update'),
                   help='Directory containing template.dat and *.inc files (default: runs/radial_homo_with-update)')
